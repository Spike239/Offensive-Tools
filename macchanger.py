...
def get_arguments():
    parser = argparse.ArgumentParser(description="Herramienta para cambiar la direccion MAC")
    parser.add_argument("-i", "--interface", required=True, dest="interface", help="Nombre de la interface de red")
    parser.add_argument("-m", "--mac", required=True, dest="mac_address", help="Nueva direccion MAC para la interface de red")
...
def change_mac_address(interface, mac_address):
    if is_valid_input(interface, mac_address):
        ...
        print(colored("\n[+] La direccion MAC ah sido cambiada exitosamente", "green"))
    else:
        print(colored("\n[!] Los valores ingresados son incorrectos", "red"))
